/*
 * Subject: A program to print some data about 3 persons in a table.
 *
...
#include<iomanip>						// 'iomanip' is, guess what :), also a header file essential for 'setw' and 'setiosflags'.
using namespace std;					// This namespace 'standard' contains the definition of 'cin' and 'cout'.
